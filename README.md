...
The video annotation file can be downloaded here: [labels.json](https://github.com/anonymous-good/sub8989/blob/main/labels.json)
...
Install the following dependencies in your local setup:
   ...
   ```bash
   $ git clone git@github.com:anonymous-good/sub8989.git
...
You can use our code of the data curation pipeline and provided annotation file (["*labels.json*"](https://github.com/anonymous-good/sub8989/blob/main/labels.json)) to recreate the whole Surg-3M dataset.
...
2. Download the annotation file (["*labels.json*"](https://github.com/anonymous-good/sub8989/blob/main/labels.json)) and use the video downloader to download the original selected Youtube videos.
